"""Example: Streamed quality training on a Hugging Face dataset without plugins.

This variant mirrors ``run_hf_image_quality.py`` but deliberately avoids
loading any plugin modules or decision controllers.  It showcases the minimal
components required to train a small Brain on quality scores from a Hugging
Face dataset.

Usage:
    py -3 examples/run_hf_image_quality_noplugins.py
"""
